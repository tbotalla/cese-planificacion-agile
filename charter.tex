...
\begin{itemize}
    ...
    \item Detección de eventos críticos: registra caídas, maniobras bruscas (aceleración/frenado) e inclinaciones excesivas. Al detectar un evento, el sistema lo regsitra para su posterior análisis.
    ...
    \item Gestión de datos: registra la información en una tarjeta \textit{microSD} mediante un esquema de \textit{double buffering} y transmite vía Bluetooth a una aplicación web.
...
\begin{itemize}
	...
	\item Desarrollo de una aplicación web que se comunique por Bluetooth para visualizar telemetría en tiempo real y mapas de recorrido.
	\item Pruebas
		\begin{itemize}
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \item story points: 8
    \end{itemize}
    \item HU4: Como responsable del proyecto, quiero un archivo de texto almacenado en una microSD con la temperatura, validar el funcionamiento del sensor de temperatura.
    \begin{itemize}
  ...
  \begin{itemize}
    ...
    \end{itemize}
  \end{itemize}
  \item \textbf{Épica 4: aplicación web}
  \begin{itemize}
    \item HU8: Como usuario, quiero ver en la web los datos del recorrido en tiempo real, para monitorear el viaje mientras circulo.
    \begin{itemize}
      \item prioridad: alta
      \item story points: 8
    \end{itemize}
    \item HU9: Como usuario, quiero ver en la web la posición actual en un mapa, para ubicarme en la ruta.
    \begin{itemize}
      \item prioridad: alta
      \item story points: 8
    \end{itemize}
    \item HU10: Como usuario, quiero cargar en la web un archivo de texto exportado de un recorrido y visualizar sus datos, para revisar viajes ya grabados sin conexión en tiempo real con la motocicleta.
    \begin{itemize}
      \item prioridad: media
      \item story points: 5
    \end{itemize}
...
\begin{itemize}
  ...
  \item \textbf{Épica 4: aplicación web}
    \begin{itemize}
      \item HU8
        \begin{itemize}
          \item La aplicación web muestra datos del recorrido recibidos en tiempo real desde el dispositivo.
      ...
      \item HU9
        \begin{itemize}
          \item La aplicación web muestra la posición actual en un mapa.
      ...
      \item HU10
        \begin{itemize}
          \item La aplicación web permite cargar un archivo de texto exportado de un recorrido.
      ...
      \item HU11
        \begin{itemize}
          \item La aplicación web muestra en el mapa los tramos asociados a aceleraciones o frenadas bruscas.
...
\textcolor{red}{¿Se puede eliminar esta sección?}
...
HU8 & Implementar vista web de datos en tiempo real & 8 h & Alta \\ \hline
HU9 & Integrar mapa web y actualizar posición actual con datos GPS válidos & 8 h & Alta \\ \hline
HU9 & Mostrar estados de desconexión en la interfaz web & 4 h & Alta \\ \hline
HU10 & Implementar carga de archivo de recorrido en la aplicación web & 6 h & Baja \\ \hline
