...
Historia de usuario & Tarea técnica & Estimación & Prioridad \\ \hline
\endhead
HU1 & Configurar la IMU: rango de medición, frecuencia de muestreo e interfaz I2C & 6 h & Alta \\ \hline
HU1 & Implementar lectura de registros principales de la IMU por I2C & 6 h & Alta \\ \hline
HU1 & Generar archivo de prueba en microSD con marcas de tiempo y muestras de la IMU & 8 h & Alta \\ \hline
HU2 & Configurar el barómetro: modo de operación, tasa de lectura e interfaz I2C & 5 h & Alta \\ \hline
HU2 & Implementar lectura de presión & 5 h & Alta \\ \hline
HU2 & Generar archivo de prueba en microSD con marcas de tiempo y muestras del barómetro & 6 h & Alta \\ \hline
HU3 & Configurar el GPS: velocidad de comunicación y tasa de actualización & 6 h & Alta \\ \hline
HU3 & Configurar UART del GPS e implementar parser básico de tramas & 8 h & Alta \\ \hline
HU3 & Registrar latitud, longitud y velocidad en microSD & 6 h & Alta \\ \hline
HU4 & Configurar sensor de temperatura & 2 h & Alta \\ \hline
HU4 & Implementar lectura de temperatura & 4 h & Alta \\ \hline
HU4 & Registrar temperatura en microSD y comparar contra una referencia de banco & 4 h & Alta \\ \hline
HU5 & Configurar DMA para transferir lecturas de IMU a un buffer en RAM & 8 h & Media \\ \hline
HU5 & Implementar el buffer de recepción DMA para las lecturas de la IMU & 8 h & Media \\ \hline
HU6 & Configurar recepción del GPS por UART con DMA hacia buffer en memoria & 8 h & Media \\ \hline
HU6 & Validar recepción de tramas completas y manejo de tramas incompletas & 6 h & Media \\ \hline
HU7 & Implementar doble buffer en RAM para muestras de IMU y GPS & 8 h & Alta \\ \hline
HU7 & Escribir bloques en microSD y validar persistencia del archivo de sesión & 8 h & Alta \\ \hline
HU8 & Definir formato de telemetría Bluetooth para datos del recorrido en vivo & 6 h & Alta \\ \hline
HU8 & Implementar vista de datos en tiempo real en la aplicación móvil & 8 h & Alta \\ \hline
HU9 & Integrar mapa en la aplicación móvil y actualizar posición actual con datos GPS válidos & 8 h & Alta \\ \hline
HU9 & Mostrar estados de desconexión en la interfaz de la aplicación móvil & 4 h & Alta \\ \hline
HU10 & Implementar carga de archivo de recorrido en la aplicación móvil & 6 h & Baja \\ \hline
HU10 & Visualizar datos cargados en tabla y mapa & 8 h & Media \\ \hline
HU11 & Definir reglas para marcar aceleraciones y frenadas bruscas en el recorrido & 6 h & Media \\ \hline
HU11 & Mostrar tramos marcados sobre el mapa desde datos en vivo o archivo cargado & 8 h & Alta \\ \hline
\end{tabularx}
...
Si el diagrama queda demasiado ancho, se puede pegar primero la tabla del Gantt y luego la parte del diagrama de barras.
...
\begin{consigna}{red}
Completar el presupuesto detallado del proyecto, considerando costos directos e indirectos.
Incluir la moneda utilizada y, si corresponde, la tasa de conversión respecto a moneda local en una fecha dada.
\end{consigna}
...
Componentes electrónicos y módulos comerciales &
  \multicolumn{1}{c|}{} &
  \multicolumn{1}{c|}{} &
  \multicolumn{1}{c|}{} \\ \hline
Materiales de conexión, montaje y prototipado &
  \multicolumn{1}{c|}{} &
  \multicolumn{1}{c|}{} &
  \multicolumn{1}{c|}{} \\ \hline
Elementos para pruebas en banco y campo &
   &
   &
   \\ \hline
...
Descripción &
  ...
  \multicolumn{1}{c|}{\cellcolor[HTML]{C0C0C0}Valor unitario} &
  \multicolumn{1}{c|}{\cellcolor[HTML]{C0C0C0}Valor total} \\ \hline
Horas de ingeniería, documentación y validación &
   &
   &
   \\ \hline
Herramientas, insumos generales y contingencias &
   &
   &
   \\ \hline
\multicolumn{3}{|c|}{SUBTOTAL} &
