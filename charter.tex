...
Para estimar el esfuerzo relativo entre historias se decidió utilizar story points.

En esa ponderación se tienen en cuenta la cantidad de trabajo, la complejidad técnica, el riesgo y la incertidumbre asociados a cada historia. Los valores son relativos en escala Fibonacci (1, 2, 3, 5, 8, 13). Como referencia de 1 story point se considera el esfuerzo de integrar un sensor en bus I2C y establecer la comunicación con el microcontrolador.
